...
$login_error = ''; // Message d'erreur de connexion initialisé à vide
...
if (isset($_POST['google_token'])) {
    ...
    if ($payload) {
        ...
        if ($user) {
            ...
            echo json_encode(['error' => 'Email non trouvé. Veuillez vous enregistrer.']);
        }
    } else {
...
<section class="min-h-screen flex items-center justify-center">
    <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8 md:px-16">
            <h2 class="font-bold text-2xl text-[#292524]">Connexion</h2>
